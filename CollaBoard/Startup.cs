...
namespace CollaBoard
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    options.Configuration = "redis-10628.c268.eu-west-1-2.ec2.cloud.redislabs.com:10628";
            //    options.InstanceName = "CollaBoardSession";
            //});
            ...
            services.AddSingleton<MongoDbConnection, MongoDbConnection>();
